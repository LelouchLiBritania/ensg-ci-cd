...
:homepage-url: https://{external-domain}
...
:demoapp-repo-web-url: http://gitserver:3000/{admin-user}/{demoapp-repo-name}
:demoapp-repo-git-url: ssh://git@gitserver:5022/{admin-user}/{demoapp-repo-name}.git
:webhook-url: http://jenkins:8080/jenkins/git/notifyCommit?url={demoapp-repo-git-url}
